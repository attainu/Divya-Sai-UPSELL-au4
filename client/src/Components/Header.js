               ...
               <div className="row top-header">
                   <div className="contact-details">
                        <ul>
                            ...
                            <li><i class="fa fa-phone mr-2"></i>98490-84400</li>
                            <li class="last"><i class="fa fa-whatsapp mr-2"></i>84275-16270</li>
                        </ul>
                   </div>
                   <div className="free-delivery-info">
                    <p>Free Delivery on order over <i class="fa fa-inr"></i>500/-</p>
                   </div>
               </div>
               </div>
               ...
               <div className="row bottom-header">
                   ...
                   <nav className="navigation">
                    ...
                    <ul>
                            ...
                            <li><Link to="/shop"><i className="fa fa-user"></i></Link></li>
